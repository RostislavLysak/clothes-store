...
const InputControl = ({
  ...
  return (
    <div className='grid w-full h-full rounded-md'>
      <div className='w-72'>
        <div className='relative h-10 w-full min-w-[200px]'>
          <input
            ...
            } px-3 py-2.5 font-sans text-sm font-normal !text-black dark:!text-white outline outline-0 transition-all placeholder-shown:border focus:border-2 focus:border-white focus:border-t-transparent focus:outline-0 ${
              disabledAnimated &&
